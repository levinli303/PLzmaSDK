...
uint64_t plzma_registrator_61(void) {
    return NArchive::NUefi::UEFIf::g_ArcInfo.Flags;
}

uint64_t plzma_registrator_70(void) {
    return NArchive::NUefi::UEFIc::g_ArcInfo.Flags;
}
#endif