...
uint64_t plzma_registrator_66(void) {
    return NArchive::NChm::NHxs::g_ArcInfo.Flags;
}
#endif

#if defined(LIBPLZMA_USING_REGISTRATORS)
uint64_t plzma_registrator_71(void) {
    return NArchive::NChm::NChm::g_ArcInfo.Flags;
}
#endif